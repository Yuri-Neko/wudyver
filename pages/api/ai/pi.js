...
class PiAI {
  constructor() {
    ...
    this.headers = {
      ...
      cookie:
        "__cf_bm=QDw4njHfnZtZgzlLf1XPqHo4rYya0ItNWN8Hijss8tc-1735692447-1.0.1.1-lp3_a0Jo7cVSxrDifuE0LrafxvYzkOpH4_uJ__Jgd6Rd_gJFbKFODKvaDAwI3gGJaZiNP6GCyxNRFx232kYi.A; __Host-session=ZRhTkBitFYSgTJNMEQAK3",
      origin: "https://pi.ai",
      priority: "u=1, i",
...
export default async function handler(req, res) {
  ...
  const { prompt: text, conversation } = req.method === "POST" ? req.body : req.query;
  const piAI = new PiAI();
