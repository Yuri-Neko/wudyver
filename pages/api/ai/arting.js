...
class Arting {
  ...
  uuid() {
    return ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(/[018]/g, c => (c ^ randomBytes(1)[0] & 15 >> c / 4).toString(16));
  }
  generateCookie() {
  ...
  async create(text = "Hello!", init_audio = 23180, language = "english", emotion = "neutral", speed = 1) {
    const payload = {
      prompt: text,
