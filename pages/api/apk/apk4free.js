  ...
  try {
    ...
    $("article").each((index, element) => {
      ...
      articles.push({
        ...
        category: $article.find('.tags a[href^="https://apk4free.org/category/"]').map((_, tagElement) => $(tagElement).text()).get(),
        tag: $article.find('.tags a[href^="https://apk4free.org/tag/"]').map((_, tagElement) => $(tagElement).text()).get(),
