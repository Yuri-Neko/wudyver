...
export default async function handler(req, res) {
  ...
  try {
    switch (action) {
      case "cekResi":
        const resiResult = await cekResi(query);
        return res.json(resiResult);
      case "enhanceImg":
        const enhancedImage = await enhanceImg(query);
        return res.json(enhancedImage);
      case "tiktokTts":
        const ttsResult = await tiktokTts(query);
        return res.json(ttsResult);
      case "ttsModel":
        const ttsModelResult = await ttsModel(query);
        return res.json(ttsModelResult);
      case "anime":
        const animeResult = await anime(query);
        return res.json(animeResult);
      case "truthOrDare":
        const truthOrDareResult = await truthOrDare();
        return res.json(truthOrDareResult);
      case "getCerpen":
        const cerpenResult = await getCerpen();
        return res.json(cerpenResult);
      case "getCerpenHorror":
        const cerpenHorrorResult = await getCerpenHorror();
        return res.json(cerpenHorrorResult);
      case "findSongs":
        const songResult = await findSongs(query);
        return res.json(songResult);
      case "igStalk":
        const igResult = await igStalk(query);
        return res.json(igResult);
      case "similarBand":
        const bandResult = await similarBand(query);
        return res.json(bandResult);
      case "otakuDesuSearch":
        const otakuResult = await otakuDesuSearch(query);
        return res.json(otakuResult);
      case "filmApikS":
        const filmSResult = await filmApikS(query);
        return res.json(filmSResult);
      case "filmApikDl":
        const filmDlResult = await filmApikDl(query);
        return res.json(filmDlResult);
      default:
