...
const referer = "https://krakenfiles.com",
  ...
  createFormData = async (content, fieldName) => {
    ...
    text: text,
    spinner: "moon"
  }), Provider = ["Catbox", "Doodstream", "Fexnet", "FileDitch", "Filebin", "Fileio", "Filezone", "FreeImage", "Gofile", "Gozic", "Hostfile", "Imgbb", "Kitc", "Kraken", "MediaUpload", "Nullbyte", "Pixeldrain", "Pomf2", "Sazumi", "Sohu", "Gizai", "Sojib", "Femboy", "Gachi", "Kappa", "Supa", "Knowee", "Puticu", "Stylar", "Telegraph", "Tmpfiles", "Babup", "Transfersh", "Ucarecdn", "Uguu", "UploadEE", "Uploadify", "Videy", "ZippyShare"];
class Uploader {
  constructor() {
