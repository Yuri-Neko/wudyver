...
class ShortLink {
  ...
  async gen(url, index = 0) {
    const providers = [this.tinyurl, this.linkpoi, this.bitly, this.ouo, this.onept, this.cleanuri, this.gotiny, this.isgd, this.vgd, this.tnyim, this.kutt, this.rebrandly, this.multishort, this.shrtco, this.vurl, this.cuttly, this.shorte, this.adfoc, this.dxyz, this.shorturl, this.ssur, this.adfly];
